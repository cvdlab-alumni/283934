...
#upSideCP = [[8.28,0,12],[8.28,0,12],[8.28,0,12],[39.33,0,12],[41.6,2.14,12],[45,3,12],[45,16.2,12],[41.6,17,12],[39.33,18.4,12],[8.28,18.4,12],[8.28,18.4,12],[0,9.2,12],[8.28,0,12],[8.28,0,12],[8.28,0,12]]
#upSideCP = [[8.28,0,0],[8.28,0,0],[8.28,0,0],[39.33,0,0],[41.6,2.14,0],[45,3,0],[45,16.2,0],[41.6,17,0],[39.33,18.4,0],[8.28,18.4,0],[0,9.2,0],[8.28,0,0],[8.28,0,0],[8.28,0,0]]
...
def semiCirclePointsX(r):
	xIn = r*2*0.05
	yOut = r*(4.0/3.0)
	return [[0,0,0],[xIn,yOut,0],[r*2 - xIn,yOut,0],[r*2,0,0]]



def circlePointsY(r,pos):
	xIn = r*2*0.05
	yOut = r*(4.0/3.0)
	return [[0,0,0],[0,xIn,yOut],[0,r*2 - xIn,yOut],[0,r*2,0],[0,r*2 - xIn,-yOut],[0,xIn,-yOut],[0,0,0]]

def semiCirclePointsZ(r,pos):
	xIn = r*2*0.05
	yOut = r*(4.0/3.0)
	return [[0+pos,0,0],[xIn+pos,0,yOut],[r*2 - xIn +pos,0,yOut],[r*2 + pos,0,0]]



semiCircle = BEZIER(S1)(semiCirclePointsZ(1,0.5))

semiCircle2 = BEZIER(S2)(circlePointsY(2,0))

#VIEW(MAP(semiCircle)(dom2D))
#VIEW(MAP(semiCircle2)(dom2D))
...
#part = NN(5)([T(1)(1)])(MAP(semiCircle)(dom1D))

#VIEW(STRUCT([MAP(wheelFront)(dom2D),MAP(wheelRear)(dom2D)]))
#VIEW(STRUCT([OFFSET([0.01,0.01,0.1])(MAP(CYLINDRICALSURFACE([wheelFront,[0,widthWheel,0]]))(dom2D)),MAP(semiCircle)(dom1D)]))

wheel = OFFSET([0.01,0.01,0.1])(MAP(CYLINDRICALSURFACE([wheelFront,[0,widthWheel,0]]))(dom2D))


tyreCP = [[widthWheel,0,0],[widthWheel,0,0.5],[widthWheel-0.2,0,0.5],[0.2,0,0.5],[0.2,0,0.5],[0.2,0,0]]
tyreProf = BEZIER(S2)(tyreCP)

#VIEW(MAP(tyreProf)(PROD([dom2D,dom1D])))
#VIEW(MAP(tyreProf)(dom2D))
wheel0 = T([1,2,3])([-11,-9.2,-4])(wheel)
wheel1= T([1,2,3])([15,-9.2,-4])(wheel)
wheel2 = T([1,2,3])([15,8.2,-4])(wheel)
wheel3 = T([1,2,3])([-11,8.2,-4])(wheel)


VIEW(STRUCT([model,wheel0,wheel1,wheel2,wheel3]))
